...
(knowledge/computations/ecco-regional-sea-level.md). Exit 0 PASS, 1 FAIL
...
DEFAULT_COMPUTATION = (Path(__file__).resolve().parent / "ecco_regional_sea_level.py")
