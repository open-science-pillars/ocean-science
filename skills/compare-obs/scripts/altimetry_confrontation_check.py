...
COMPARISON = HERE / "ecco_ssh_vs_altimetry.py"
PARTITION = SKILLS / "sea-level-analysis" / "scripts" / "ecco_regional_sea_level.py"
SCORING = HERE / "ecco_rapid_amoc_confrontation.py"
