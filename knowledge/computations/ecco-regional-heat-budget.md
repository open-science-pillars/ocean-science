...
sources:
  ...
  - id: geothermal-gotcha
    resource: knowledge/podaac/gotchas/ecco-geothermal-flux.md
...
`knowledge/podaac/computations/ecco-regional-heat-budget.md`, and the
...
run `regional-heat` reads the ECCO 2010 fixture cache, which this
environment does not hold, so it was not re-run here; the committed
demonstration exhibit-regional-heat-2005.json does attest PASS at the
...
[^geothermal-gotcha]: knowledge/podaac/gotchas/ecco-geothermal-flux.md, and the measured 1.24e-12 omission inside the absolute bar
