...
type: dataset-gotcha
spheres: [hydrosphere]
title: "The Roemmich and Gilson anomalies are departures from a fixed 2004 to 2018 climatology"
...
sources:
  ...
  - id: rg-climatology-temperature
    ...
    title: "The 2004 to 2018 temperature climatology file: its header read 2026-09-13 from the first 4 MB of the archive, then the whole file downloaded the same day and read with netCDF4; it carries the mean field and the 180 monthly anomalies defined by the Jan 2004 to Dec 2018 climatology"
  - id: rg-page
...
over a whole number of years unchanged; over a window that is not a
whole number of years, the difference between the two annual cycles
projects onto the slope by the months the window leaves unbalanced. The WCRP assessment records the consequence for
...
did; a trend from a single-release series fitted over whole years is
unaffected by the choice of reference period, and a trend over any
window is quoted with the period it was fitted over.
...
the archive and again from the whole file once downloaded, carries
the mean field and the anomaly long
