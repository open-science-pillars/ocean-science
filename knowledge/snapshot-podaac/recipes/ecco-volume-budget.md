...
budget closes on transport convergence alone (the shared architecture is
the [budget formulation convention](../conventions/ecco-budget-formulation.md)).[^budget-formulation]
